/*******************************************************************************
 System Initialisation File
  ...
  Description:
    This file contains source code necessary to initialise the system.
 *******************************************************************************/
...
// #pragma config ALTI2C1 = ON             // Alternative I2C pins for I2C1 (SDA1/SCK1 pins are selected as the I/O pins
// #pragma config ALTI2C2 = OFF            // Alternative I2C pins for I2C2 (SDA2/SCK2 are selected as I/O pins)
