...
#define SYSTEM_PERIPHERAL_CLOCK (40000000)
#pragma message "This module requires a definition for the peripheral clock frequency."
#endif

#define CLOCK_DIVIDER TIMER_PRESCALER_1
#define PR3_SETTING (SYSTEM_PERIPHERAL_CLOCK/100/1)
